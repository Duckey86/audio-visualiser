...
const SPOTIFY_AUTH_FILE = process.env.SPOTIFY_AUTH_FILE || path.join(__dirname, '.spotify-auth.json');
...
const PATCH_ALLOWED_ROOTS = new Set(['public', 'desktop', 'build', 'providers']);
