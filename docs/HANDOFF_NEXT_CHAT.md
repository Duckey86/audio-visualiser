...
- 已新增 Spotify Connect Provider；首次真实授权与 Electron UI 验证需按 docs/SPOTIFY_SETUP.md 配置 Client ID。
- Spotify 严格保持 Connect 控制/资料模式，不下载、代理或分析 Spotify 音频，视觉使用 ambient 模式。
